...
public class AddController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("add_page.jsp"); //show error same home.jsp page
...
//        });
        String type = request.getParameter("input-type");
        String heading = request.getParameter("input-heading");
